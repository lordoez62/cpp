...
int main(int argc, char const *argv[])
{
    ...
    while (true) // Acceso al sistema
    {
        ...
        cout<< "Ingrese su usuario o presiona 9 para salir: "<< endl;
        cin>> usuario;
        if (usuario == "9")
        {
            break;
        ...
        else if (resultado == 3)
        {
            while (opcion != 8)
            {
                ...
                cout<< "2. Cuentas por pagar" << endl;
                cout<< "3. Aseo de habitaciones" << endl;
                cout<< "8. Salir del sistema" << endl;
                cin>> opcion;
                ...
                switch (opcion)
                {
                    while (seleccion != 9)
                    {
                        case 1: // Vista de habitaciones disponibles
                        {
                            while (seleccion !=9)
                            {
                                system("cls"); 
